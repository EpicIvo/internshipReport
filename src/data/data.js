  ...
  projects: {
    ninlaro: {
      ...
      content: [{
        ...
        type: 'paragraph',
        content: 'Het eindresultaat was positief! Nadat het aardig fout ging bij de eerste meeting kwam het in deze meeting uiteindelijk toch goed. Het werk dat ik heb geleverd was goed ontvangen door Takeda. Hierdoor was het eindresultaat toch erg positief.'
      }, {
        type: 'subTitle',
        content: 'Conclusie'
      }, {
        ...
        type: 'paragraph',
        content: 'Ik dacht dat dit wel iets zou zijn dat vaker terug zou komen en dus heb ik besloten dit beheerbaar te maken in Wordpress (in plaats van een eenmalige uitzondering). De klant was erg tevreden met mijn oplossing: '
      }, {
        type: 'quote',
        content: 'Thank you for thinking more long-term Ivo, this would make it a lot easier :)'
      }, {
        type: 'criteriaTitle',

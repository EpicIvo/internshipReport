const dataObject = {
    projects: {
      ninlaro: {
        ...
        content: [{
          ...
          type: 'paragraph',
          content: 'De klant had in een google drive folder alle content gezet met daarbij informatie over waar het moest komen te staan. Dit was de data dat ik gebruikte om te checken of alles goed stond. En na dit alles te zijn doorgelopen leek het allemaal goed te staan.'
        }, {
          type: 'subTitle',
          content: 'Meeting'
        }, {
          ...
          type: 'paragraph',
          content: 'Voor ik begon aan dit project had ik nog nooit echt iets gedaan met Wordpress. Deze techniek was voor mij erg nieuw. Toch moest ik er tijdens het verwerken van feedback veel mee doen. Ik heb door het schrijven van functionaliteit veel geleerd van Wordpress. Gelukkig had ik al kennis van Php en Drupal waardoor ik veel herkende, zodat ik er goed in kon duiken. Nu ben ik binnen Burst vaker bezig met Wordpress projecten!'
        }, {
          type: 'criteriaTitle',
          content: 'Ontwikkelend > Testen en implementeren'
        }, {
          type: 'paragraph',
          content: 'Ik moest veel verschillende functionaliteiten schrijven die van belang waren voor de werking van de website. Dus moest ik ervoor zorgen dat deze functionaliteiten op een correcte wijze werden getest om de kwaliteit van de werking te verzekeren. Dit heb ik gedaan. Per functionaliteit testte ik de werking ervan functioneel. Ook heb ik in veel call’s gezeten met de klant om samen live door de website te lopen, om te kijken of alles ook echt goed werkt. '
        }, {
          type: 'paragraph',
        ...
        attachments: [{
          title: 'Nice surprise',
          href: 'https://files.ivovanderknaap.com/img/ninlaro-nice-surprise.png'
        }, {
          title: 'Klant reactie',
          href: 'https://files.ivovanderknaap.com/img/ninlaro-client-reaction.png'
        }, {
          title: 'Gesprek',
          href: 'https://files.ivovanderknaap.com/img/ninlaro-logo-conversation.png'
        }, {
          title: 'Oude logo',
          href: 'https://files.ivovanderknaap.com/img/ninlaro-logo-old.png'
        }, {
          title: 'Nieuw logo',
          href: 'https://files.ivovanderknaap.com/img/ninlaro-logo-new.png'
        }]
      },
      davidoff: {
        title: 'Davidoff',
      ...
      schwartau: {
        ...
        path:
          '/schwartau',
        href:
          'https://www.schwartau.de/home/kontakt',
        content:
          [{
            type: 'paragraph',
            ...
            type: 'subTitle',
            content: 'Site structuur'
          }, {
            type: 'paragraph',
            content: 'De website van Schwartau was onderverdeeld in drie taken. Peter deed de styling van alle elementen. Bart maakte het producten filter. Dit filter was anders dan het normale filter van Hero omdat Schwartau een extra laag aan categorieën heeft waar dus een extra laag met filtering in moest komen. Aan mij was de taak om de structuur van de site in Drupal na te bouwen. Zoals ik dat had geleerd in mijn allereerste project met Mentos Japan, moest ik in Drupal de structuur die de klant ons had gestuurd nabouwen.'
          }, {
            type: 'subTitle',
            content: 'Contact formulier'
          }, {
            type: 'paragraph',
            content: 'Een aantal weken voor ik iets wist over de website van Schwartau kreeg ik een opdracht van Jeroen, onze Head of Production. Ik moest namelijk starten met het maken van de connectie van onze server met de database van Schwartau. Dit specifieke “projectje” is mijn langst lopende project ooit geweest. En soms ook niet het allerleukste. Toen ik ermee begon wist ik het minimale van devOps, servers en database connecties af. Het was voor mij dus goed hier veel over te leren! '
          }, {
            type: 'paragraph',
      ...
      iffr: {
        ...
        content:
          [{
            type: 'paragraph',
            content: 'Binnen Team CDSP was Kai eigenlijk de enige die tickets oppakte voor IFFR. Hij wist als enige ook iets af van het platform. Naast Kai zijn Matthijs P. en ik de Drupal backenders van het team. Het probleem dat hieruit ontstond was dat het festival dichterbij kwam en er meerdere tickets binnen kwamen. Kai was de enige die deze tickets echt op kon pakken en Kai werkte maar één dag in de week! Er waren dus teveel tickets voor IFFR om opgepakt te kunnen worden door Kai. Aangezien ik IFFR een gaaf project vind en ik hier en daar nog wat ruimte vond in mijn planning besloot ik in te stappen om eens naar die tickets te kijken.'
          }, {
            type: 'subTitle',
            content: 'Team'
          }, {
            ...
            type: 'paragraph',
            content: 'Naast mijn overname van IFFR tickets van Kai heb ik al eerder een aantal tickets voor de site opgepakt. Ik kende de site dus al een klein beetje.'
          }, {
            type: 'paragraph',
            content: 'IFFR had bijvoorbeeld een keer de vraag of we een splitsing konden maken in hun Press release overview. Vanuit een externe bron haalden we in JSON formaat vele nieuws artikelen op die we in een overzicht op de website lieten zien. Nu wilden ze dat we deze JSON feed splitste in artikelen van IFFR zelf en externe bronnen. Mijn taak was dus om dit in JavaScript in elkaar te zetten.'
          }, {
            type: 'subTitle',
            ...
            type: 'subTitle',
            content: 'Backend bugs'
          }, {
            type: 'paragraph',
            content: 'De verdere tickets die ik over heb genomen van Kai bestonden vooral uit bugjes in de structuur van Drupal of in de backend code. Zo misten er verschillende foto’s op de overzichtspagina omdat ze verkeerd in code werden opgehaald. En er zat een foutje in de rendering van het FAQ overzicht. In de uitgelichte vragen kwamen vragen voor die niet gepubliceerd waren! '
          }, {
            type: 'paragraph',
            content: 'Al met al was Kai erg blij dat ik hem hielp. Hij had zelf nooit genoeg tijd gehad dit zelf te doen en met mijn hulp is het toch afgekomen!'
          }, {
            type: 'criteriaTitle',
            content: 'Ondernemend > Projectmatig werken'
          }, {
            ...
            type: 'paragraph',
            content: 'Langzaamaan beginnen we de ‘way of working’ steeds te verbeteren om uiteindelijk de ticket counter, die nu op 114 staat, te verlagen naar nul!'
          }, {
            type: 'criteriaTitle',
    ...
    categories: {
      ontwikkelend: {
        ...
        criteria:
          [{
            title: 'Technische kennis en analyse',
            ...
            title: 'Ontwikkelen en prototypen',
      ...
      onderzoekend: {
        ...
        criteria:
          [{
            title: 'Onderzoeken en analyseren',
